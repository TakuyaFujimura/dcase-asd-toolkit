...
curl -L -O "https://zenodo.org/record/6355122/files/dev_${machine_type}.zip"
...
cd ${eval_dir}
for machine_type in bearing fan gearbox slider ToyCar ToyTrain valve; do
curl -L -O "https://zenodo.org/record/6462969/files/eval_data_${machine_type}_train.zip"
unzip "eval_data_${machine_type}_train.zip"

curl -L -O "https://zenodo.org/record/6586456/files/eval_data_${machine_type}_test.zip"
